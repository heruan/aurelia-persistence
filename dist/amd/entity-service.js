define(["exports", "./filter-query", "./sorting", "aurelia-json", "http-utils", "url-template"], function (exports, _filterQuery, _sorting, _aureliaJson, _httpUtils, _urlTemplate) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.EntityService = undefined;
    ...
    var EntityService = exports.EntityService = function () {
        ...
        EntityService.prototype.link = function link(relation) {
            ...
            return _urlTemplate2.default.parse(this.links.get(relation)).expand(params);
        };

        EntityService.prototype.searchMessage = function searchMessage(requestId, path) {
            var filter = arguments.length <= 2 || arguments[2] === undefined ? new _filterQuery.FilterQuery() : arguments[2];
            ...
            var sort = arguments.length <= 5 || arguments[5] === undefined ? new _sorting.Sorting() : arguments[5];
            ...
            var request = builder.withHeader(_httpUtils.HttpHeaders.CONTENT_TYPE, _httpUtils.MediaType.APPLICATION_JSON).withHeader(EntityService.FILTER_HEADER, JSON.stringify(filter)).withHeader(EntityService.LIMIT_HEADER, "" + limit).withHeader(EntityService.SKIP_HEADER, "" + skip).withHeader(EntityService.SORT_HEADER, JSON.stringify(sort)).withProgressCallback(progressCallback).send();
            if (requestId) {
        ...
        EntityService.prototype.count = function count(requestId) {
            var filter = arguments.length <= 1 || arguments[1] === undefined ? new _filterQuery.FilterQuery() : arguments[1];
        ...
        EntityService.prototype.findAll = function findAll(requestId) {
            ...
            var sort = arguments.length <= 4 || arguments[4] === undefined ? new _sorting.Sorting() : arguments[4];
        ...
        EntityService.prototype.findOne = function findOne(requestId) {
            ...
            var sort = arguments.length <= 3 || arguments[3] === undefined ? new _sorting.Sorting() : arguments[3];
        ...
        EntityService.prototype.persist = function persist(entity) {
            ...
            if (contentType) {
                requestBuilder.withHeader(_httpUtils.HttpHeaders.CONTENT_TYPE, contentType);
            }
            return requestBuilder.withContent(entity).withProgressCallback(progressCallback).send().then(function (success) {
                if (success.headers.has(_httpUtils.HttpHeaders.LOCATION)) {
                    var location = success.headers.get(_httpUtils.HttpHeaders.LOCATION);
        ...
        EntityService.prototype.patch = function patch(entity) {
            ...
            if (patch.length > 0) {
                ...
                return this.requestBuilder(relation, entity, params).asPatch().withHeader(_httpUtils.HttpHeaders.CONTENT_TYPE, _httpUtils.MediaType.APPLICATION_JSON_PATCH).withContent(patch).withProgressCallback(progressCallback).send().then(function (success) {
        ...
        EntityService.prototype.stringify = function stringify(entity) {
            return new _aureliaJson.JsonEncoder().encode(entity);
        };
        ...
        EntityService.prototype.inferContentType = function inferContentType(entity) {
            ...
            if (typeof entity === "string") {
                return _httpUtils.MediaType.TEXT_PLAIN;
            }
            return _httpUtils.MediaType.APPLICATION_JSON;
        };
