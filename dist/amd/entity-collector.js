define(["exports", "./entity-service", "./filter-query"], function (exports, _entityService, _filterQuery) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.EntityCollector = undefined;
    ...
    var EntityCollector = exports.EntityCollector = function () {
        ...
        EntityCollector.prototype.load = function load(limit, skip) {
            ...
            return this.entityService.searchMessage(this.name, path, this.currentFilter, limit, skip, this.defaultSorting, this.properties).then(function (success) {
                ...
                _this2.countTotal = +success.headers.get(_entityService.EntityService.COUNT_TOTAL_HEADER);
                _this2.countFilter = +success.headers.get(_entityService.EntityService.COUNT_FILTER_HEADER);
        ...
        EntityCollector.prototype.filter = function filter(callback, value) {
            ...
            if (value !== undefined) {
                callbackFilter = new _filterQuery.FilterQuery();
                callback.call(callbackFilter, callbackFilter, value);
            } else {
                this.currentFilter = this.defaultFilter;
            }
            if (callbackFilter !== null && this.defaultFilter !== null) {
                this.currentFilter = new _filterQuery.FilterQuery().and(callbackFilter, this.defaultFilter);
