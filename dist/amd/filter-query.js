define(["exports", "aurelia-dependency-injection", "./group-filter", "./field-filter", "./text-filter"], function (exports, _aureliaDependencyInjection, _groupFilter, _fieldFilter, _textFilter) {
    "use strict";
