define(["exports", "./filter-query"], function (exports, _filterQuery) {
    "use strict";

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.FieldFilter = undefined;
            ...
            for (var field in object) {
                switch (field) {
                    case FieldFilter.ELEM_MATCH:
                        filter.elemMatch(_filterQuery.FilterQuery.fromObject(object[field]));
                        break;
                    default:
