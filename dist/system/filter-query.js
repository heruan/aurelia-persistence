...
System.register(["aurelia-dependency-injection", "./group-filter", "./field-filter", "./text-filter"], function (_export, _context) {
    "use strict";

    var autoinject, GroupFilter, FieldFilter, TextFilter, _typeof, __decorate, __metadata, FilterQuery_1, FilterQuery;
    ...
    return {
        ...
        }, function (_groupFilter) {
            GroupFilter = _groupFilter.GroupFilter;
        }, function (_fieldFilter) {
            FieldFilter = _fieldFilter.FieldFilter;
        ...
        execute: function () {
            ...
            FilterQuery_1 = function () {
                ...
                FilterQuery.prototype.mod = function mod(fieldName, _mod) {
                    return this.field(fieldName, new FieldFilter().mod(_mod));
                };

                FilterQuery.prototype.regex = function regex(fieldName, _regex) {
                    return this.field(fieldName, new FieldFilter().regex(_regex));
                };
                    ...
                    for (var field in object) {
                        switch (field) {
                            ...
                            case TextFilter.TEXT:
                                ...
                                break;
                            default:
                                filter.field(field, FieldFilter.fromObject(object[field]));
                        }
                    }
                    return filter;
                };
            ...
            _export("FilterQuery", FilterQuery = FilterQuery_1);

            _export("FilterQuery", FilterQuery);

            FilterQuery.FILTERING_EVENT = "aurelia.persistence.filtering";
            _export("FilterQuery", FilterQuery = FilterQuery_1 = __decorate([autoinject, __metadata('design:paramtypes', [FilterQuery])], FilterQuery));
        }
    };
});