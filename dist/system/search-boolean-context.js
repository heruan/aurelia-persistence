...
System.register(["aurelia-dependency-injection", "./search-boolean-query"], function (_export, _context) {
    "use strict";

    var autoinject, SearchBooleanQuery, _typeof, __decorate, __metadata, SearchBooleanContext;
    ...
    return {
        ...
        }, function (_searchBooleanQuery) {
            SearchBooleanQuery = _searchBooleanQuery.SearchBooleanQuery;
        }],
        execute: function () {
            ...
            _export("SearchBooleanContext", SearchBooleanContext = function () {
                ...
                SearchBooleanContext.prototype.must = function must() {
                    ...
                    return (_bool = this.bool).call.apply(_bool, [this, SearchBooleanQuery.MUST].concat(queries));
                };
                ...
                SearchBooleanContext.prototype.should = function should() {
                    ...
                    return (_bool2 = this.bool).call.apply(_bool2, [this, SearchBooleanQuery.SHOULD].concat(queries));
                };
                ...
                SearchBooleanContext.prototype.unsetMust = function unsetMust() {
                    ...
                    return (_unsetBool = this.unsetBool).call.apply(_unsetBool, [this, SearchBooleanQuery.MUST].concat(queries));
                };
                ...
                SearchBooleanContext.prototype.unsetShould = function unsetShould() {
                    ...
                    return (_unsetBool2 = this.unsetBool).call.apply(_unsetBool2, [this, SearchBooleanQuery.SHOULD].concat(queries));
                };
            ...
            _export("SearchBooleanContext", SearchBooleanContext = __decorate([autoinject, __metadata('design:paramtypes', [])], SearchBooleanContext));
        }
    };
});